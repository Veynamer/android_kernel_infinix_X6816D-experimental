...
struct charger_regulator {
    ...
    struct device_attribute attr_temperature_enable;//Added by qinjinke@sagereal.com for NVA-1087 adb set temperature 2022-09-19
    struct device_attribute attr_temperature_customize;//Added by qinjinke@sagereal.com for NVA-1087 adb set temperature 2022-09-19
